...
router.post("/chatbot/message", async (req, res) => {
  try {
    ...
    if (!baseUrl || !apiKey) {
      res.json({
        message: "I am the ADR Shield AI assistant. Unfortunately the AI service is not currently configured. For drug safety information, please consult a pharmacist or physician. This system is for advisory purposes only.",

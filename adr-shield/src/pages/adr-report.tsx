...
import { useCreateAdrReport } from "@workspace/api-client-react";
...
import { NewAdrReportInputSeverity } from "@workspace/api-client-react/src/generated/api.schemas";
...
export default function AdrReportForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Tell us a Problem</h1>
        <p className="text-slate-500 mt-1">Did a medicine make you feel unwell? Tell us so we can help others.</p>
      </div>
      ...
      <Alert className="bg-amber-50 border-amber-200 text-amber-800">
        ...
        <AlertDescription>
          If this is a medical emergency, please call your local emergency services or proceed to the nearest emergency room immediately. Do not wait for a response from this system.
        </AlertDescription>
      </Alert>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>All information is kept strictly confidential in accordance with medical data standards.</CardDescription>
          </CardHeader>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="mild">Mild (Resolved quickly, no intervention)</SelectItem>
                    <SelectItem value="moderate">Moderate (Required medical intervention)</SelectItem>
                    <SelectItem value="severe">Severe (Hospitalization/Life-threatening)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
          ...
          <CardFooter className="bg-slate-50 border-t flex justify-between px-6 py-4">
            ...
            <Button type="submit" disabled={createReport.isPending}>
              {createReport.isPending ? "Submitting securely..." : "Submit Official Report"}
            </Button>
          </CardFooter>
        </Card>
      </form>

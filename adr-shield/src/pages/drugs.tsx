...
export default function DrugsList() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Medicine Guide</h1>
        <p className="text-slate-500 mt-1">Search for any pill to see how to use it safely.</p>
      </div>
